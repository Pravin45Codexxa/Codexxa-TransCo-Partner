package com.codexxatransco.partner.model;
...
public class Account{
	...
	public com.codexxatransco.partner.model.User getUser() {
		return user;
	}

	public void setUser(com.codexxatransco.partner.model.User user) {
		this.user = user;
	}
